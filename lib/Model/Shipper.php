 ...
 */
class Shipper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return ShipperModelFields
      */
    public static function GetModelFields(): ShipperModelFields
    {
        return new ShipperModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return ShipperModelAttributes
      */
    public static function GetModelAttributes(): ShipperModelAttributes
    {
        return new ShipperModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shipper';
    ...
    */
    ...
    public function setName1($name1)
    {
        ...
        if ((mb_strlen($name1) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name1 when calling Shipper., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name1 when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setName2($name2)
    {
        ...
        if ((mb_strlen($name2) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name2 when calling Shipper., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name2 when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setName3($name3)
    {
        ...
        if ((mb_strlen($name3) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name3 when calling Shipper., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name3 when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressStreet($address_street)
    {
        ...
        if ((mb_strlen($address_street) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_street when calling Shipper., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($address_street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_street when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressHouse($address_house)
    {
        ...
        if ((mb_strlen($address_house) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_house when calling Shipper., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($address_house) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_house when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling Shipper., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($postal_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling Shipper., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[0-9A-Za-z]+([ -]?[0-9A-Za-z]+)*$/", ObjectSerializer::toString($postal_code)))) {
            throw new \InvalidArgumentException("invalid value for \$postal_code when calling Shipper., must conform to the pattern /^[0-9A-Za-z]+([ -]?[0-9A-Za-z]+)*$/.");
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Shipper., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setContactName($contact_name)
    {
        ...
        if ((mb_strlen($contact_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling Shipper., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($contact_name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling Shipper., must be bigger than or equal to 3.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 80)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Shipper., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Shipper., must be bigger than or equal to 3.');
        }
