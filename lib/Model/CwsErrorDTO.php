 ...
 */
class CwsErrorDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return CwsErrorDTOModelFields
      */
    public static function GetModelFields(): CwsErrorDTOModelFields
    {
        return new CwsErrorDTOModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return CwsErrorDTOModelAttributes
      */
    public static function GetModelAttributes(): CwsErrorDTOModelAttributes
    {
        return new CwsErrorDTOModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CwsErrorDTO';
    ...
    */
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id The Correlation ID to track the request through all systems where it has been processed.
     *
     * @return self
     */
     ...
     * Sets messages
     *
     * @param string[]|null $messages A list of messages. Any single error is described within a certain message.
     *
     * @return self
     */
    public function setMessages($messages)
    {
        ...
        if ((count($messages) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $messages when calling CwsErrorDTO., number of items must be less than or equal to 2147483647.');
        }
        if ((count($messages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $messages when calling CwsErrorDTO., number of items must be greater than or equal to 1.');
        }
