<?php
/**
 * GetAccessTokenResponseModelAttributes
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * GetAccessTokenResponseModelAttributes Class Doc Comment
 *
 * @category Class
 * @package  Spy\DHLParcel
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetAccessTokenResponseModelAttributes
{
    public string $strAccessToken = 'access_token';
    public string $strTokenType = 'token_type';
    public string $strExpiresIn = 'expires_in';
}
