 ...
 */
class ItemData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return ItemDataModelFields
      */
    public static function GetModelFields(): ItemDataModelFields
    {
        return new ItemDataModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return ItemDataModelAttributes
      */
    public static function GetModelAttributes(): ItemDataModelAttributes
    {
        return new ItemDataModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?![=\\-\\+@]).*/", $this->container['address_line1'])) {
            $invalidProperties[] = "invalid value for 'address_line1', must be conform to the pattern /^(?![=\\-\\+@]).*/.";
        }
        ...
        if (!is_null($this->container['address_line2']) && !preg_match("/^(?![=\\-\\+@]).*/", $this->container['address_line2'])) {
            $invalidProperties[] = "invalid value for 'address_line2', must be conform to the pattern /^(?![=\\-\\+@]).*/.";
        }
        ...
        if (!is_null($this->container['recipient_fax']) && (mb_strlen($this->container['recipient_fax']) > 25)) {
            $invalidProperties[] = "invalid value for 'recipient_fax', the character length must be smaller than or equal to 25.";
        }
        ...
        if (!is_null($this->container['recipient_phone']) && (mb_strlen($this->container['recipient_phone']) > 25)) {
            $invalidProperties[] = "invalid value for 'recipient_phone', the character length must be smaller than or equal to 25.";
        }
        ...
        if (!is_null($this->container['shipment_currency']) && (mb_strlen($this->container['shipment_currency']) > 3)) {
            $invalidProperties[] = "invalid value for 'shipment_currency', the character length must be smaller than or equal to 3.";
        }

        if (!is_null($this->container['shipment_currency']) && (mb_strlen($this->container['shipment_currency']) < 3)) {
            $invalidProperties[] = "invalid value for 'shipment_currency', the character length must be bigger than or equal to 3.";
        }

        if (!is_null($this->container['shipment_currency']) && !preg_match("/[A-Z]{3}/", $this->container['shipment_currency'])) {
            $invalidProperties[] = "invalid value for 'shipment_currency', must be conform to the pattern /[A-Z]{3}/.";
        }
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling ItemData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?![=\\-\\+@]).*/", $address_line1))) {
            throw new \InvalidArgumentException("invalid value for \$address_line1 when calling ItemData., must conform to the pattern /^(?![=\\-\\+@]).*/.");
        }
    ...
    public function setAddressLine2($address_line2)
    {
        ...
        if ((mb_strlen($address_line2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling ItemData., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^(?![=\\-\\+@]).*/", $address_line2))) {
            throw new \InvalidArgumentException("invalid value for \$address_line2 when calling ItemData., must conform to the pattern /^(?![=\\-\\+@]).*/.");
        }
    ...
    public function setAddressLine3($address_line3)
    {
        ...
        if ((mb_strlen($address_line3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ItemData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ItemData., must be bigger than or equal to 1.');
        }
     ...
     * Sets cust_ref
     *
     * @param string|null $cust_ref Reference text up to customer's choice
     *
     * @return self
     */
    public function setCustRef($cust_ref)
    {
        ...
        if ((mb_strlen($cust_ref) > 28)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref when calling ItemData., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cust_ref) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setCustRef2($cust_ref2)
    {
        ...
        if ((mb_strlen($cust_ref2) > 28)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref2 when calling ItemData., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cust_ref2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref2 when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setCustRef3($cust_ref3)
    {
        ...
        if ((mb_strlen($cust_ref3) > 28)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref3 when calling ItemData., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cust_ref3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref3 when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setDestinationCountry($destination_country)
    {
        ...
        if ((mb_strlen($destination_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $destination_country when calling ItemData., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($destination_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $destination_country when calling ItemData., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/[A-Z]{2}/", $destination_country))) {
            throw new \InvalidArgumentException("invalid value for \$destination_country when calling ItemData., must conform to the pattern /[A-Z]{2}/.");
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ItemData., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($postal_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ItemData., must be bigger than or equal to 3.');
        }
     ...
     * Sets product
     *
     * @param string $product The product that is used for the shipment of this item. Available products are: GPP (Packet Plus), GMP (Packet), GMM (Business Mail Standard), GMR (Business Mail Registered), GPT (Packet Tracked).246/247/... (Internet Stamp Product)
     *
     * @return self
     */
    ...
    public function setImporterTaxId($importer_tax_id)
    {
        ...
        if ((mb_strlen($importer_tax_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $importer_tax_id when calling ItemData., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($importer_tax_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $importer_tax_id when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setRecipient($recipient)
    {
        ...
        if ((mb_strlen($recipient) > 30)) {
            throw new \InvalidArgumentException('invalid length for $recipient when calling ItemData., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($recipient) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipient when calling ItemData., must be bigger than or equal to 1.');
        }
    ...
    public function setRecipientEmail($recipient_email)
    {
        ...
        if ((mb_strlen($recipient_email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $recipient_email when calling ItemData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($recipient_email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $recipient_email when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setRecipientFax($recipient_fax)
    {
        ...
        if ((mb_strlen($recipient_fax) > 25)) {
            throw new \InvalidArgumentException('invalid length for $recipient_fax when calling ItemData., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($recipient_fax) < 0)) {
            throw new \InvalidArgumentException('invalid length for $recipient_fax when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setRecipientPhone($recipient_phone)
    {
        ...
        if ((mb_strlen($recipient_phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $recipient_phone when calling ItemData., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($recipient_phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $recipient_phone when calling ItemData., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param bool|null $return_item_wanted States if a return label should be created additionally. Requires a contract for Packet Return.
     *
     * @return self
     */
    ...
    public function setSenderAddressLine1($sender_address_line1)
    {
        ...
        if ((mb_strlen($sender_address_line1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender_address_line1 when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender_address_line1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_address_line1 when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderAddressLine2($sender_address_line2)
    {
        ...
        if ((mb_strlen($sender_address_line2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender_address_line2 when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender_address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_address_line2 when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderCity($sender_city)
    {
        ...
        if ((mb_strlen($sender_city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender_city when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender_city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_city when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderCountry($sender_country)
    {
        ...
        if ((mb_strlen($sender_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sender_country when calling ItemData., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($sender_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $sender_country when calling ItemData., must be bigger than or equal to 2.');
        }
    ...
    public function setSenderEmail($sender_email)
    {
        ...
        if ((mb_strlen($sender_email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sender_email when calling ItemData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($sender_email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_email when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderName($sender_name)
    {
        ...
        if ((mb_strlen($sender_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender_name when calling ItemData., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_name when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderPhone($sender_phone)
    {
        ...
        if ((mb_strlen($sender_phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $sender_phone when calling ItemData., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($sender_phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_phone when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderPostalCode($sender_postal_code)
    {
        ...
        if ((mb_strlen($sender_postal_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $sender_postal_code when calling ItemData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($sender_postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_postal_code when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderTaxId($sender_tax_id)
    {
        ...
        if ((mb_strlen($sender_tax_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sender_tax_id when calling ItemData., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($sender_tax_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_tax_id when calling ItemData., must be bigger than or equal to 0.');
        }
    ...
    public function setShipmentCurrency($shipment_currency)
    {
        ...
        if ((mb_strlen($shipment_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $shipment_currency when calling ItemData., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($shipment_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $shipment_currency when calling ItemData., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/[A-Z]{3}/", $shipment_currency))) {
            throw new \InvalidArgumentException("invalid value for \$shipment_currency when calling ItemData., must conform to the pattern /[A-Z]{3}/.");
        }
    ...
    public function setShipmentGrossWeight($shipment_gross_weight)
    {
        ...
        if (($shipment_gross_weight > 2000)) {
            throw new \InvalidArgumentException('invalid value for $shipment_gross_weight when calling ItemData., must be smaller than or equal to 2000.');
        }
        if (($shipment_gross_weight < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipment_gross_weight when calling ItemData., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ItemData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ItemData., must be bigger than or equal to 0.');
        }
