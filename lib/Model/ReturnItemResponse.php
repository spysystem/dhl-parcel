...
/**
 * ReturnItemResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\DHLParcel
 * @author   OpenAPI Generator team
 ...
 */
class ReturnItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return ReturnItemResponseModelFields
      */
    public static function GetModelFields(): ReturnItemResponseModelFields
    {
        return new ReturnItemResponseModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return ReturnItemResponseModelAttributes
      */
    public static function GetModelAttributes(): ReturnItemResponseModelAttributes
    {
        return new ReturnItemResponseModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnItemResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?![=\\-\\+@]).*/", $this->container['sender_name'])) {
            $invalidProperties[] = "invalid value for 'sender_name', must be conform to the pattern /^(?![=\\-\\+@]).*/.";
        }
    ...
    public function setCustRef($cust_ref)
    {
        ...
        if ((mb_strlen($cust_ref) > 28)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref when calling ReturnItemResponse., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cust_ref) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cust_ref when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^(?![=\\-\\+@]).*/", $cust_ref))) {
            throw new \InvalidArgumentException("invalid value for \$cust_ref when calling ReturnItemResponse., must conform to the pattern /^(?![=\\-\\+@]).*/.");
        }
    ...
    public function setSenderName($sender_name)
    {
        ...
        if ((mb_strlen($sender_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender_name when calling ReturnItemResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender_name when calling ReturnItemResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?![=\\-\\+@]).*/", $sender_name))) {
            throw new \InvalidArgumentException("invalid value for \$sender_name when calling ReturnItemResponse., must conform to the pattern /^(?![=\\-\\+@]).*/.");
        }
    ...
    public function setSenderEmail($sender_email)
    {
        ...
        if ((mb_strlen($sender_email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sender_email when calling ReturnItemResponse., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($sender_email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sender_email when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling ReturnItemResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling ReturnItemResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        ...
        if ((mb_strlen($address_line2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling ReturnItemResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        ...
        if ((mb_strlen($address_line3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling ReturnItemResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($address_line3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ReturnItemResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ReturnItemResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ReturnItemResponse., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ReturnItemResponse., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ReturnItemResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets barcode
     *
     * @param string|null $barcode The barcode of this return item.
     *
     * @return self
     */
