...
/**
 * V3TrackingEventModelFields Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class V3TrackingEventModelFields
{
    public string $strStatus = 'status';
    public string $strStatusMessage = 'statusMessage';
    public string $strEventType = 'eventType';
