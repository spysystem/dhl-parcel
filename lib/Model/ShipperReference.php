 ...
 */
class ShipperReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return ShipperReferenceModelFields
      */
    public static function GetModelFields(): ShipperReferenceModelFields
    {
        return new ShipperReferenceModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return ShipperReferenceModelAttributes
      */
    public static function GetModelAttributes(): ShipperReferenceModelAttributes
    {
        return new ShipperReferenceModelAttributes();
    }
    ...
    */
    ...
    public function setShipperRef($shipper_ref)
    {
        ...
        if ((mb_strlen($shipper_ref) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shipper_ref when calling ShipperReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($shipper_ref) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipper_ref when calling ShipperReference., must be bigger than or equal to 0.');
        }
