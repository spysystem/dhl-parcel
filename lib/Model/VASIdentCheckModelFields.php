...
/**
 * VASIdentCheckModelFields Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class VASIdentCheckModelFields
{
    public string $strFirstName = 'firstName';
    public string $strLastName = 'lastName';
    public string $strDateOfBirth = 'dateOfBirth';
    public string $strMinimumAge = 'minimumAge';
}
