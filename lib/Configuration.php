...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-eu.dhl.com/parcel/de/shipping/v2';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator-php';
    ...
    {
        $report  = 'PHP SDK (Spy\DHLParcel) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.1.9' . PHP_EOL;
